...
function test6(text) {
    ...
    var res = text.charAt(num);

    return res;

    // Varför blir den inte godkänd?
...
function test7(firstname, surname) {
    ...
    var res = surname.concat(", " + firstname);
...
//(se länktips i handledningen)
function test11(arr) {
    var median = Math.round(arr.length / 2 - 1);

    var value = arr[median];
